...
const ManageMyPost = () => {
  ...
  console.log('My Added Volunters Post:', volunteers);

  // Delete Function 
  const handleDelete = async id => {
    try {
      const { data } = await axiosCus.delete(`/volunteer/${id}`)
      console.log(data)
  ...
  return (
    <section className='container px-4 mx-auto pt-12'>
      <div className='flex items-center gap-x-3'>
        <h2 className='text-lg font-medium text-gray-800 '>My Add Volunteer Post</h2>

        <span className='px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full '>
          {volunteers.length} jobs
        </span>
      </div>
